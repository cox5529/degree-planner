...
namespace DegreePlanner.Migrations
{
    ...
    [Migration("20181129041627_DegreePlanParams")]
    partial class DegreePlanParams
    {
            ...
            modelBuilder.Entity("Degree_Planner.Models.DegreePlan", b =>
                {
                    b.HasOne("Degree_Planner.Models.User", "User")
                        .WithOne("DegreePlan")
                        .HasForeignKey("Degree_Planner.Models.DegreePlan", "UserID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
